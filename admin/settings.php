...
<div class="digiblocks-admin-wrap">
	<div class="digiblocks-admin-header">
		...
		<nav class="digiblocks-admin-tabs">
			...
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=digiblocks-settings' ) ); ?>" class="<?php echo ( ! isset( $_GET['tab'] ) ) ? 'active' : ''; ?>">
	...
	<div class="digiblocks-admin-content">
		<div class="digiblocks-admin-col digiblocks-admin-first">
			<?php if ( isset( $_GET['tab'] ) && 'ai' === $_GET['tab'] && $is_pro_active && digiblocks_pro_has_access() ) : ?>
				<?php require_once DIGIBLOCKS_PRO_PLUGIN_DIR . 'admin/ai-settings.php'; ?>
			<?php else : ?>
