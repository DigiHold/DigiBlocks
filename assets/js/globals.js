(() => {
  ...
  var DimensionControl = ({
    ...
    const [isLinked, setIsLinked] = useState2(values.isLinked !== void 0 ? values.isLinked : true);
  ...
  var GradientControl = ({ value, onChange }) => {
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-control" }, /* @__PURE__ */ wp.element.createElement(
      ToggleControl,
      {
        label: __3("Enable Gradient", "digiblocks"),
        checked: enable,
      ...
      ToggleGroupControl2,
      {
        label: __3("Gradient Type", "digiblocks"),
        value: type,
      ...
      /* @__PURE__ */ wp.element.createElement(
        ...
        {
          value: "radial",
          label: __3("Radial", "digiblocks")
        }
      )
    ), type === "linear" && /* @__PURE__ */ wp.element.createElement(
      RangeControl,
      {
        label: __3("Angle", "digiblocks"),
        value: angle,
    ...
    ), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-colors" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-colors-header" }, /* @__PURE__ */ wp.element.createElement("strong", null, __3("Colors", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
      Button3,
      {
        variant: "secondary",
        isSmall: true,
  ...
  var { useState: useState4, useEffect: useEffect3 } = window.wp.element;
  var TypographyControl = ({ label, value, onChange, defaults = {} }) => {
    const [controlId] = useState4(`typography-${Math.random().toString(36).substr(2, 9)}`);
    const [isOpen, setIsOpen] = useState4(() => {
      return window.digi.uiState.getPanelState("typography", controlId) ?? false;
    });
    const [fontWeightOptions, setFontWeightOptions] = useState4([
      { label: __4("Default", "digiblocks"), value: "" },
      { label: "100", value: "100" },
      { label: "200", value: "200" },
      { label: "300", value: "300" },
      { label: "400", value: "400" },
    ...
    const [fontFamilyOptions, setFontFamilyOptions] = useState4([
      { label: __4("Default", "digiblocks"), value: "" },
      { label: __4("System UI", "digiblocks"), value: "system-ui" },
      { label: __4("Arial", "digiblocks"), value: "Arial, sans-serif" },
      { label: __4("Helvetica", "digiblocks"), value: "Helvetica, sans-serif" },
      { label: __4("Times New Roman", "digiblocks"), value: "Times New Roman, serif" },
      { label: __4("Georgia", "digiblocks"), value: "Georgia, serif" }
    ]);
    const [fontLoaded, setFontLoaded] = useState4(false);
    ...
    useEffect3(() => {
      ...
      if (googleFontsData && googleFontsData[values.fontFamily] && googleFontsData[values.fontFamily].weight) {
        ...
        const weights = fontData.weight.map((weight) => ({
          label: weight === "Default" ? __4("Default", "digiblocks") : weight,
    ...
    const fontStyleOptions = [
      { label: __4("Default", "digiblocks"), value: "normal" },
      { label: __4("Italic", "digiblocks"), value: "italic" },
      { label: __4("Oblique", "digiblocks"), value: "oblique" }
    ];
    const textTransformOptions = [
      { label: __4("Default", "digiblocks"), value: "" },
      { label: __4("None", "digiblocks"), value: "none" },
      { label: __4("Capitalize", "digiblocks"), value: "capitalize" },
      { label: __4("Uppercase", "digiblocks"), value: "uppercase" },
      { label: __4("Lowercase", "digiblocks"), value: "lowercase" }
    ];
    const textDecorationOptions = [
      { label: __4("Default", "digiblocks"), value: "" },
      { label: __4("None", "digiblocks"), value: "none" },
      { label: __4("Underline", "digiblocks"), value: "underline" },
      { label: __4("Overline", "digiblocks"), value: "overline" },
      { label: __4("Line Through", "digiblocks"), value: "line-through" }
    ];
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: `digiblocks-typography-options digiblocks-control-popup__options ${isOpen ? "active" : ""}` }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options--action-wrapper" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label || __4("Typography", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
      ...
      SelectControl2,
      {
        label: __4("Transform", "digiblocks"),
      ...
      SelectControl2,
      {
        label: __4("Decoration", "digiblocks"),
    ...
    )))))), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-control-inner" }, /* @__PURE__ */ wp.element.createElement("div", { className: "components-base-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-range-control digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control__header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-label-wrap" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, __4("Letter Spacing", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
      Button4,
      {
        className: "digiblocks-responsive-common-button",
        onClick: handleToggleDevice,
  ...
  var ResponsiveRangeControl = ({
    ...
    const [currentUnit, setCurrentUnit] = useState5(defaultUnit);
    const [inputValue, setInputValue] = useState5("");
    const [inputId] = useState5(`range-control-${Math.floor(Math.random() * 1e4)}`);
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-control-inner" }, /* @__PURE__ */ wp.element.createElement("div", { className: "components-base-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-range-control digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control__header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-label-wrap" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement(
      ...
      ToggleGroupControl4,
      {
        ...
        isSmall: true,
        hideLabelFromVision: true,
        "aria-label": __5("Select Units", "digiblocks"),
        __next40pxDefaultSize: true,
        __nextHasNoMarginBottom: true
      },
      units.map((unit) => /* @__PURE__ */ wp.element.createElement(
  ...
  var { RangeControl: RangeControl3, TabPanel, ToggleControl: ToggleControl2, __experimentalToggleGroupControl: ToggleGroupControl6, __experimentalToggleGroupControlOption: ToggleGroupControlOption6 } = window.wp.components;
  ...
  var BoxShadowControl = ({
    ...
    const renderShadowControls = (tab) => {
      ...
      return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-box-shadow-controls" }, label && /* @__PURE__ */ wp.element.createElement("h2", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-toggle-wrapper", style: { marginBottom: "16px" } }, /* @__PURE__ */ wp.element.createElement(
        ToggleControl2,
        {
          label: __7("Enable Box Shadow", "digiblocks"),
        ...
        RangeControl3,
        {
          label: __7("Horizontal", "digiblocks"),
      ...
      ), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-multi-buttons-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-multi-buttons-control__label" }, __7("Position", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
        ToggleGroupControl6,
        {
  ...
  var { useState: useState7, useEffect: useEffect6, useRef } = window.wp.element;
  ...
  var FontAwesomeControl = ({
    label = __9("Icon", "digiblocks"),
    value = null,
    onChange
  }) => {
    const [isModalOpen, setIsModalOpen] = useState7(false);
    const [icons, setIcons] = useState7([]);
    const [categories, setCategories] = useState7([]);
    const [selectedCategory, setSelectedCategory] = useState7("all");
    ...
    const [visibleIcons, setVisibleIcons] = useState7([]);
    ...
    const processIconData = () => {
      ...
      try {
        ...
        setCategories([{ id: "all", name: __9("All Icons", "digiblocks"), count: 0 }]);
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-font-awesome-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-custom-ip" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement(
      ...
      /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-actions" }, /* @__PURE__ */ wp.element.createElement("span", null, value ? __9("Change Icon", "digiblocks") : __9("Click to choose your icon", "digiblocks")))
      ...
      /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-header" }, /* @__PURE__ */ wp.element.createElement("h2", null, __9("Select Icon", "digiblocks")), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-search-container" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-search-bar" }, /* @__PURE__ */ wp.element.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, /* @__PURE__ */ wp.element.createElement("path", { d: "M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z" })), /* @__PURE__ */ wp.element.createElement(
        ...
        "span",
        {
          ...
          title: __9("Clear Search", "digiblocks")
        },
        "\xD7"
      )))),
      hasError && /* @__PURE__ */ wp.element.createElement(Notice, { status: "error", isDismissible: false }, /* @__PURE__ */ wp.element.createElement("strong", null, __9("Icon Loading Error:", "digiblocks")), /* @__PURE__ */ wp.element.createElement("br", null), errorMessage, /* @__PURE__ */ wp.element.createElement("br", null), /* @__PURE__ */ wp.element.createElement("br", null), /* @__PURE__ */ wp.element.createElement("strong", null, __9("Troubleshooting:", "digiblocks")), /* @__PURE__ */ wp.element.createElement("ul", { style: { marginLeft: "20px", marginTop: "10px" } }, /* @__PURE__ */ wp.element.createElement("li", null, __9("1. Make sure you've run the icon generation script: npm run generate:icons", "digiblocks")), /* @__PURE__ */ wp.element.createElement("li", null, __9("2. Check that includes/icons/all-icons.json exists and is not empty", "digiblocks")), /* @__PURE__ */ wp.element.createElement("li", null, __9("3. Try clearing your browser cache and refreshing the page", "digiblocks")))),
      /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-lr-container" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-left" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-categories-list" }, categories.map((category) => /* @__PURE__ */ wp.element.createElement(
        ...
        __9("Load More", "digiblocks"),
        " (",
        icons.length - visibleIcons.length,
        " ",
        __9("remaining", "digiblocks"),
        ")"
      ))))),
  ...
  window.digi.createDeviceToggleButton = (Button8, className = "") => {
    const { __: __10 } = window.wp.i18n;
    return /* @__PURE__ */ wp.element.createElement(
      Button8,
      {
  ...
  window.digi.components.TabPanelBody = ({ tab, name, title, children, initialOpen = false }) => {
    ...
    const { useState: useState8, useEffect: useEffect7 } = window.wp.element;
    ...
    const [isOpen, setIsOpen] = useState8(getSavedState());
