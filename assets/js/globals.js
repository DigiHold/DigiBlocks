(() => {
  ...
  // resources/js/utils/units-selector.js
  var { __ } = window.wp.i18n;
  var { useState, useRef, useEffect } = window.wp.element;
  var UnitsSelector = ({
    value = "px",
    onChange,
    units = [
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-units-wrapper", ref: wrapperRef }, /* @__PURE__ */ wp.element.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-units-switcher__label" }, selectedUnit.label),
      /* @__PURE__ */ wp.element.createElement("span", { className: `dashicon dashicons dashicons-arrow-down-alt2 digiblocks-units-switcher__icon` })
    ), isOpen && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-units-choices" }, units.map((unit) => /* @__PURE__ */ wp.element.createElement("div", { key: unit.value, className: "digiblocks-units-choice" }, /* @__PURE__ */ wp.element.createElement(
      "input",
      {
      ...
      /* @__PURE__ */ wp.element.createElement("span", null, unit.label)
    )))));
  };
  var units_selector_default = UnitsSelector;

  // resources/js/utils/helpers.js
  var useBlockId = (id, clientId, setAttributes) => {
    const { useEffect: useEffect9 } = window.wp.element;
  ...
  var animationPreview = (id, animation, animations2, previewTimeoutRef, animationDuration = "normal", animationDelay = 0) => {
    ...
    if (animations2[animation]) {
      ...
      const cleanupDelay = (animationDuration === "slow" ? 2e3 : animationDuration === "fast" ? 500 : 1e3) + animationDelay;
  ...
  var { cloneElement, Children, isValidElement, useEffect: useEffect2, useState: useState2 } = window.wp.element;
  var ResponsiveControl = ({
    label,
    children
  }) => {
    const [activeDevice, setLocalActiveDevice] = useState2(
    ...
    const createToggleButton = () => {
      return /* @__PURE__ */ wp.element.createElement(
        Button,
        {
          ...
          "aria-label": __2(`Switch to ${getNextDevice()} view`, "digiblocks")
        },
      ...
      const childrenWithProps = Children.map(children, (child) => {
        if (isValidElement(child)) {
          return cloneElement(child, {
            ...
            deviceLabel: __2(`Switch to ${getNextDevice()} view`, "digiblocks")
          });
        }
        return child;
      });
  ...
  var { Button: Button2, Dashicon } = window.wp.components;
  ...
  var DimensionControl = ({
    ...
    const [isLinked, setIsLinked] = useState3(values.isLinked !== void 0 ? values.isLinked : true);
    const UnitsSelector2 = window.digi?.utils?.UnitsSelector;
    const [isDefault, setIsDefault] = useState3(true);
    const [activeDevice, setLocalActiveDevice] = useState3(window.digi.responsiveState.activeDevice);
    useEffect3(() => {
      if (isResponsive) {
        const unsubscribe = window.digi.responsiveState.subscribe((device) => {
          setLocalActiveDevice(device);
    ...
    useEffect3(() => {
      if (values.isLinked !== void 0 && values.isLinked !== isLinked) {
    ...
    const handleUnitChange = (unit) => {
      onChange({
        ...
        unit,
        isLinked
        // Include current isLinked state
      });
    };
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: `digiblocks-dimension-control ${isResponsive ? "is-responsive" : ""}` }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control__header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-label-wrap" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label), isResponsive && /* @__PURE__ */ wp.element.createElement(
      Button2,
      {
        ...
        onClick: handleToggleDevice,
        "aria-label": deviceLabel || __3(`Switch to ${window.digi.responsiveState.getNextDevice()} view`, "digiblocks")
      },
      renderDeviceIcon()
      ...
      Button2,
      {
        ...
        onClick: resetValues,
        disabled: isDefault,
        "aria-label": __3("Reset", "digiblocks")
      }
    )), UnitsSelector2 && /* @__PURE__ */ wp.element.createElement(
      UnitsSelector2,
      {
        value: values.unit,
        onChange: handleUnitChange,
        units,
        ariaLabel: __3("Select Units", "digiblocks")
      }
      ...
      "input",
      {
        ...
        max: getMaxValue(values.unit),
        step: getStepValue(values.unit),
        "aria-label": __3("Right", "digiblocks")
      }
    ), /* @__PURE__ */ wp.element.createElement(
      "input",
      {
        ...
        max: getMaxValue(values.unit),
        step: getStepValue(values.unit),
        "aria-label": __3("Bottom", "digiblocks")
      }
    ), /* @__PURE__ */ wp.element.createElement(
      "input",
      {
        ...
        max: getMaxValue(values.unit),
        step: getStepValue(values.unit),
        "aria-label": __3("Left", "digiblocks")
      }
    ), /* @__PURE__ */ wp.element.createElement(
      "span",
      {
        ...
        title: isLinked ? __3("Unlink values", "digiblocks") : __3("Link values", "digiblocks"),
        role: "button",
        tabIndex: "0",
        onKeyPress: (event) => {
    ...
    )), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-spacing-labels" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-spacing-label" }, __3("Top", "digiblocks")), /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-spacing-label" }, __3("Right", "digiblocks")), /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-spacing-label" }, __3("Bottom", "digiblocks")), /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-spacing-label" }, __3("Left", "digiblocks")), /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-spacing-label digiblocks-spacing-link-label" })));
  };
  var dimension_control_default = DimensionControl;

  // resources/js/components/gradient-control.js
  ...
  var { useState: useState4 } = window.wp.element;
  var GradientControl = ({ value, onChange }) => {
    const {
      enable = false,
      type = "linear",
      angle = 90,
    ...
    const updateColorStop = (index, newColorValue, newPosition) => {
      const newColors = [...colors];
      newColors[index] = {
        color: newColorValue !== void 0 ? newColorValue : newColors[index].color,
        position: newPosition !== void 0 ? newPosition : newColors[index].position
      };
      updateGradient({ colors: newColors });
    };
    const radialPositionOptions = [
      { label: __4("Top Left", "digiblocks"), value: "top left" },
      { label: __4("Top Center", "digiblocks"), value: "top center" },
      { label: __4("Top Right", "digiblocks"), value: "top right" },
      { label: __4("Center Left", "digiblocks"), value: "center left" },
      { label: __4("Center Center", "digiblocks"), value: "center center" },
      { label: __4("Center Right", "digiblocks"), value: "center right" },
      { label: __4("Bottom Left", "digiblocks"), value: "bottom left" },
      { label: __4("Bottom Center", "digiblocks"), value: "bottom center" },
      { label: __4("Bottom Right", "digiblocks"), value: "bottom right" }
    ];
    const generatePreviewCSS = () => {
      if (!enable || !colors.length)
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-control" }, /* @__PURE__ */ wp.element.createElement(
      ToggleControl,
      {
        label: __4("Enable Gradient", "digiblocks"),
        checked: enable,
        onChange: (newEnable) => updateGradient({ enable: newEnable }),
        __nextHasNoMarginBottom: true
      }
    ), enable && /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-preview" }, /* @__PURE__ */ wp.element.createElement(
      "div",
      {
      ...
      ToggleGroupControl,
      {
        label: __4("Gradient Type", "digiblocks"),
        value: type,
      ...
      /* @__PURE__ */ wp.element.createElement(
        ...
        {
          value: "radial",
          label: __4("Radial", "digiblocks")
        }
      )
    ), type === "linear" && /* @__PURE__ */ wp.element.createElement(
      RangeControl,
      {
        label: __4("Angle", "digiblocks"),
        value: angle,
    ...
    ), type === "radial" && /* @__PURE__ */ wp.element.createElement(
      SelectControl,
      {
        label: __4("Position", "digiblocks"),
        value: position,
    ...
    ), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-colors" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-colors-header" }, /* @__PURE__ */ wp.element.createElement("strong", null, __4("Colors", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
      Button3,
      {
        variant: "secondary",
        isSmall: true,
      ...
      __4("Add Color", "digiblocks")
    )), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-color-stops" }, colors.map((colorStop, index) => /* @__PURE__ */ wp.element.createElement("div", { key: index, className: "digiblocks-gradient-color-stop" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-color-stop-color" }, /* @__PURE__ */ wp.element.createElement(
      Dropdown,
      {
        ...
        renderToggle: ({ isOpen, onToggle }) => /* @__PURE__ */ wp.element.createElement(
          ...
          /* @__PURE__ */ wp.element.createElement(ColorIndicator, { colorValue: colorStop.color })
        ),
    ...
    )), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-color-stop-position" }, /* @__PURE__ */ wp.element.createElement(
      RangeControl,
      {
        value: colorStop.position,
        onChange: (newPosition) => updateColorStop(index, void 0, newPosition),
        min: 0,
        max: 100,
        step: 1,
        __next40pxDefaultSize: true,
    ...
    )), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-gradient-color-stop-remove" }, /* @__PURE__ */ wp.element.createElement(
      Button3,
      {
        isDestructive: true,
        isSmall: true,
  ...
  var gradient_control_default = GradientControl;
  ...
  var { useState: useState5, useEffect: useEffect4 } = window.wp.element;
  var TypographyControl = ({ label, value, onChange, defaults = {} }) => {
    const [controlId] = useState5(`typography-${Math.random().toString(36).substr(2, 9)}`);
    const [isOpen, setIsOpen] = useState5(() => {
      return window.digi.uiState.getPanelState("typography", controlId) ?? false;
    });
    const UnitsSelector2 = window.digi?.utils?.UnitsSelector;
    const [fontWeightOptions, setFontWeightOptions] = useState5([
      { label: __5("Default", "digiblocks"), value: "" },
      { label: "100", value: "100" },
      { label: "200", value: "200" },
      { label: "300", value: "300" },
      { label: "400", value: "400" },
    ...
    const [fontFamilyOptions, setFontFamilyOptions] = useState5([
      { label: __5("Default", "digiblocks"), value: "" },
      { label: __5("System UI", "digiblocks"), value: "system-ui" },
      { label: __5("Arial", "digiblocks"), value: "Arial, sans-serif" },
      { label: __5("Helvetica", "digiblocks"), value: "Helvetica, sans-serif" },
      { label: __5("Times New Roman", "digiblocks"), value: "Times New Roman, serif" },
      { label: __5("Georgia", "digiblocks"), value: "Georgia, serif" }
    ]);
    const [fontLoaded, setFontLoaded] = useState5(false);
    ...
    useEffect4(() => {
      ...
      if (googleFontsData && googleFontsData[values.fontFamily] && googleFontsData[values.fontFamily].weight) {
        ...
        const weights = fontData.weight.map((weight) => ({
          label: weight === "Default" ? __5("Default", "digiblocks") : weight,
    ...
    const fontStyleOptions = [
      { label: __5("Default", "digiblocks"), value: "normal" },
      { label: __5("Italic", "digiblocks"), value: "italic" },
      { label: __5("Oblique", "digiblocks"), value: "oblique" }
    ];
    const textTransformOptions = [
      { label: __5("Default", "digiblocks"), value: "" },
      { label: __5("None", "digiblocks"), value: "none" },
      { label: __5("Capitalize", "digiblocks"), value: "capitalize" },
      { label: __5("Uppercase", "digiblocks"), value: "uppercase" },
      { label: __5("Lowercase", "digiblocks"), value: "lowercase" }
    ];
    const textDecorationOptions = [
      { label: __5("Default", "digiblocks"), value: "" },
      { label: __5("None", "digiblocks"), value: "none" },
      { label: __5("Underline", "digiblocks"), value: "underline" },
      { label: __5("Overline", "digiblocks"), value: "overline" },
      { label: __5("Line Through", "digiblocks"), value: "line-through" }
    ];
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: `digiblocks-typography-options digiblocks-control-popup__options ${isOpen ? "active" : ""}` }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options--action-wrapper" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label || __5("Typography", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
    ...
    )), isOpen && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-popover digiblocks-control-popup" }, /* @__PURE__ */ wp.element.createElement("div", { className: "components-base-control digiblocks-font-family-searchable-select__wrapper" }, /* @__PURE__ */ wp.element.createElement("label", { className: "components-input-control__label", htmlFor: "font-family" }, __5("Font Family", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
      SelectControl2,
      {
        id: "font-family",
      ...
      UnitsSelector2,
      {
        ...
        units: fontSizeUnits,
        ariaLabel: __5("Select Units", "digiblocks")
      }
      ...
      SelectControl2,
      {
        label: __5("Transform", "digiblocks"),
      ...
      SelectControl2,
      {
        label: __5("Decoration", "digiblocks"),
    ...
    )))))), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-control-inner" }, /* @__PURE__ */ wp.element.createElement("div", { className: "components-base-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-range-control digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control__header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-label-wrap" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, __5("Letter Spacing", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
      Button4,
      {
        className: "digiblocks-responsive-common-button",
        onClick: handleToggleDevice,
  ...
  var { Button: Button5 } = window.wp.components;
  var { useState: useState6, useEffect: useEffect5 } = window.wp.element;
  var ResponsiveRangeControl = ({
    ...
    const [localActiveDevice, setLocalActiveDevice] = useState6(
      window.digi?.responsiveState?.activeDevice || "desktop"
    );
    const UnitsSelector2 = window.digi?.utils?.UnitsSelector;
    const [currentUnit, setCurrentUnit] = useState6(defaultUnit);
    const [inputValue, setInputValue] = useState6("");
    const [inputId] = useState6(`range-control-${Math.floor(Math.random() * 1e4)}`);
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-control-inner" }, /* @__PURE__ */ wp.element.createElement("div", { className: "components-base-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-range-control digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control__header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-label-wrap" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement(
      Button5,
      {
        className: "digiblocks-responsive-common-button",
        onClick: handleToggleDevice,
        "aria-label": __6(`Switch to ${window.digi?.responsiveState?.getNextDevice() || "next"} view`, "digiblocks")
      },
      getDeviceIcon(localActiveDevice)
    )), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-range-control__actions digiblocks-control__actions" }, /* @__PURE__ */ wp.element.createElement("div", { tabIndex: "0" }, /* @__PURE__ */ wp.element.createElement(
      "button",
      ...
      /* @__PURE__ */ wp.element.createElement("span", { className: "dashicon dashicons dashicons-image-rotate" })
    )), units && units.length > 1 && UnitsSelector2 && /* @__PURE__ */ wp.element.createElement(
      UnitsSelector2,
      {
        value: currentUnit,
        onChange: (unit) => {
        ...
        units,
        ariaLabel: __6("Select Units", "digiblocks")
      }
  ...
  var { useState: useState7, useEffect: useEffect6, useMemo } = window.wp.element;
  ...
  var ResponsiveButtonGroup = ({
    ...
    const [localActiveDevice, setLocalActiveDevice] = useState7(
      window.digi?.responsiveState?.activeDevice || "desktop"
    );
    const blockDefaults = useSelect((select) => {
      ...
      for (const [attrName, attrValue] of Object.entries(currentAttributes)) {
        if (attrValue === value && blockType.attributes[attrName]?.default) {
          ...
          if (typeof defaultValue === "object" && defaultValue.desktop !== void 0 && defaultValue.tablet !== void 0 && defaultValue.mobile !== void 0) {
            return defaultValue;
          }
        }
      }
    ...
    const ensureResponsiveValue = (val) => {
      ...
      return {
        desktop: val.desktop !== void 0 ? val.desktop : "",
        tablet: val.tablet !== void 0 ? val.tablet : "",
        mobile: val.mobile !== void 0 ? val.mobile : ""
      };
    };
    const values = ensureResponsiveValue(value);
    ...
    const getDefaultValue = (device) => {
      if (blockDefaults && blockDefaults[device] !== void 0) {
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-control-inner" }, /* @__PURE__ */ wp.element.createElement("div", { className: "components-base-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-range-control digiblocks-size-type-field-tabs" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control__header" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-responsive-label-wrap" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement(
      Button6,
      {
        className: "digiblocks-responsive-common-button",
        onClick: handleToggleDevice,
        "aria-label": __7(`Switch to ${window.digi?.responsiveState?.getNextDevice() || "next"} view`, "digiblocks")
      },
      getDeviceIcon(localActiveDevice)
    )), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-range-control__actions digiblocks-control__actions" }, /* @__PURE__ */ wp.element.createElement("div", { tabIndex: "0" }, /* @__PURE__ */ wp.element.createElement(
      "button",
  ...
  var { RangeControl: RangeControl3, TabPanel, ToggleControl: ToggleControl2, __experimentalToggleGroupControl: ToggleGroupControl3, __experimentalToggleGroupControlOption: ToggleGroupControlOption3 } = window.wp.components;
  ...
  var BoxShadowControl = ({
    ...
    const renderShadowControls = (tab) => {
      ...
      return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-box-shadow-controls" }, label && /* @__PURE__ */ wp.element.createElement("h2", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-toggle-wrapper", style: { marginBottom: "16px" } }, /* @__PURE__ */ wp.element.createElement(
        ToggleControl2,
        {
          label: __8("Enable Box Shadow", "digiblocks"),
        ...
        RangeControl3,
        {
          label: __8("Horizontal", "digiblocks"),
      ...
      ), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-multi-buttons-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-multi-buttons-control__label" }, __8("Position", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
        ToggleGroupControl3,
        {
  ...
  // resources/js/components/transform-control.js
  ...
  var { useState: useState8, useEffect: useEffect7 } = window.wp.element;
  var TransformControl = ({
    ...
    const [controlId] = useState8(`transform-${Math.random().toString(36).substr(2, 9)}`);
    const [isRotateOpen, setIsRotateOpen] = useState8(() => {
      return window.digi.uiState.getPanelState("transform-rotate", controlId) ?? false;
    });
    const [isOffsetOpen, setIsOffsetOpen] = useState8(() => {
      return window.digi.uiState.getPanelState("transform-offset", controlId) ?? false;
    });
    const [isScaleOpen, setIsScaleOpen] = useState8(() => {
      return window.digi.uiState.getPanelState("transform-scale", controlId) ?? false;
    });
    const [isSkewOpen, setIsSkewOpen] = useState8(() => {
    ...
    const hasTransformValues = (transform) => {
      ...
      const hasScale = transform.keepProportions ? transform.scale?.desktop !== "" || transform.scale?.tablet !== "" || transform.scale?.mobile !== "" : transform.scaleX?.desktop !== "" || transform.scaleX?.tablet !== "" || transform.scaleX?.mobile !== "" || transform.scaleY?.desktop !== "" || transform.scaleY?.tablet !== "" || transform.scaleY?.mobile !== "";
    ...
    const renderTransformControls = (tab) => {
      ...
      const ResponsiveRangeControl2 = window.digi.components.ResponsiveRangeControl;
      const ResponsiveButtonGroup2 = window.digi.components.ResponsiveButtonGroup;
      return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-transform-controls" }, label && /* @__PURE__ */ wp.element.createElement("h2", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options--action-wrapper" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, __9("Rotate", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
        "button",
        {
          type: "button",
        ...
        /* @__PURE__ */ wp.element.createElement("span", { className: "dashicon dashicons dashicons-edit" })
      )), isRotateOpen && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-popover digiblocks-control-popup" }, /* @__PURE__ */ wp.element.createElement(
        ResponsiveRangeControl2,
        {
          label: __9("Rotate (deg)", "digiblocks"),
        ...
        ToggleControl3,
        {
          label: __9("3D Rotate", "digiblocks"),
          checked: currentValue.rotate3d,
          onChange: (value) => updateTransformProperty(tab, "rotate3d", value),
          __next40pxDefaultSize: true,
          __nextHasNoMarginBottom: true
        }
      ), currentValue.rotate3d && /* @__PURE__ */ wp.element.createElement(wp.element.Fragment, null, /* @__PURE__ */ wp.element.createElement(
        ResponsiveRangeControl2,
        {
          label: __9("Rotate X (deg)", "digiblocks"),
        ...
        ResponsiveRangeControl2,
        {
          label: __9("Rotate Y (deg)", "digiblocks"),
        ...
        ResponsiveRangeControl2,
        {
          label: __9("Perspective (px)", "digiblocks"),
      ...
      )))), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options--action-wrapper" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, __9("Offset", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
        "button",
        {
          type: "button",
        ...
        /* @__PURE__ */ wp.element.createElement("span", { className: "dashicon dashicons dashicons-edit" })
      )), isOffsetOpen && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-popover digiblocks-control-popup" }, /* @__PURE__ */ wp.element.createElement(
        ResponsiveRangeControl2,
        {
          label: __9("Offset X", "digiblocks"),
      ...
      ))), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options--action-wrapper" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, __9("Scale", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
        "button",
        {
          type: "button",
        ...
        /* @__PURE__ */ wp.element.createElement("span", { className: "dashicon dashicons dashicons-edit" })
      )), isScaleOpen && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-popover digiblocks-control-popup" }, /* @__PURE__ */ wp.element.createElement(
        ToggleControl3,
        {
          label: __9("Keep Proportions", "digiblocks"),
          checked: currentValue.keepProportions,
          onChange: (value) => updateTransformProperty(tab, "keepProportions", value),
          __next40pxDefaultSize: true,
          __nextHasNoMarginBottom: true
        }
      ), currentValue.keepProportions ? /* @__PURE__ */ wp.element.createElement(
        ResponsiveRangeControl2,
        {
          label: __9("Scale", "digiblocks"),
      ...
      )))), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-control-popup__options--action-wrapper" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, __9("Skew", "digiblocks")), /* @__PURE__ */ wp.element.createElement(
        "button",
        {
          type: "button",
        ...
        /* @__PURE__ */ wp.element.createElement("span", { className: "dashicon dashicons dashicons-edit" })
      )), isSkewOpen && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-popover digiblocks-control-popup" }, /* @__PURE__ */ wp.element.createElement(
        ResponsiveRangeControl2,
        {
          label: __9("Skew X (deg)", "digiblocks"),
        ...
        ResponsiveRangeControl2,
        {
          label: __9("Skew Y (deg)", "digiblocks"),
      ...
      ))), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-toggle-wrapper", style: { marginTop: "1rem" } }, /* @__PURE__ */ wp.element.createElement(
        ToggleControl3,
        {
          label: __9("Flip Horizontal", "digiblocks"),
        ...
        ToggleControl3,
        {
          label: __9("Flip Vertical", "digiblocks"),
          checked: currentValue.flipVertical,
          onChange: (value) => updateTransformProperty(tab, "flipVertical", value),
          __next40pxDefaultSize: true,
          __nextHasNoMarginBottom: true
        }
      )), showAnchorPoints && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-anchor-wrapper", style: { marginTop: "1rem" } }, /* @__PURE__ */ wp.element.createElement(
        ResponsiveButtonGroup2,
        {
          label: __9("X Anchor Point", "digiblocks"),
          value: currentValue.xAnchor,
          onChange: (value) => updateTransformProperty(tab, "xAnchor", value),
          options: [
            { label: __9("Left", "digiblocks"), value: "left" },
            { label: __9("Center", "digiblocks"), value: "center" },
            { label: __9("Right", "digiblocks"), value: "right" }
          ]
        }
      ), /* @__PURE__ */ wp.element.createElement(
        ResponsiveButtonGroup2,
        {
          label: __9("Y Anchor Point", "digiblocks"),
      ...
      )), tab === "hover" && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-anchor-wrapper", style: { marginTop: "1rem" } }, /* @__PURE__ */ wp.element.createElement(
        RangeControl4,
        {
          label: __9("Transition Duration (ms)", "digiblocks"),
          value: currentValue.transitionDuration || void 0,
          onChange: (value) => updateTransformProperty(tab, "transitionDuration", value === void 0 ? "" : value),
          min: 0,
          max: 3e3,
          step: 50,
          allowReset: true,
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-transform-control" }, /* @__PURE__ */ wp.element.createElement(
      TabPanel2,
      {
        className: "digiblocks-control-tabs",
        activeClass: "active-tab",
  ...
  var transform_control_default = TransformControl;
  ...
  var { useState: useState9, useEffect: useEffect8, useRef: useRef2 } = window.wp.element;
  ...
  var FontAwesomeControl = ({
    label = __11("Icon", "digiblocks"),
    value = null,
    onChange
  }) => {
    const [isModalOpen, setIsModalOpen] = useState9(false);
    const [icons, setIcons] = useState9([]);
    const [categories, setCategories] = useState9([]);
    ...
    const iconsCache = useRef2({});
    const [visibleIcons, setVisibleIcons] = useState9([]);
    ...
    const processIconData = () => {
      ...
      try {
        ...
        const processedIcons = Object.entries(rawIcons).filter(([key]) => key !== "digiblocks_category_list" && key !== "_metadata").map(([id, iconData]) => {
          try {
            ...
            if (iconData.custom_categories && Array.isArray(iconData.custom_categories)) {
              categories2 = Array.from(new Set(iconData.custom_categories));
            }
            const processedIcon = {
              id,
        ...
        const processedCategories = [
          ...
          {
            id: "all",
            name: __11("All Icons", "digiblocks"),
        ...
        setCategories([{ id: "all", name: __11("All Icons", "digiblocks"), count: 0 }]);
      ...
      try {
        ...
        if (searchTerm.trim().length > 0) {
          ...
          filteredIcons = filteredIcons.filter(
            (icon) => icon.name.toLowerCase().includes(term) || icon.id.toLowerCase().includes(term) || icon.categories.some((cat) => cat.toLowerCase().includes(term))
          );
        }
    ...
    return /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-font-awesome-control" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-custom-ip" }, /* @__PURE__ */ wp.element.createElement("span", { className: "digiblocks-control-label" }, label), /* @__PURE__ */ wp.element.createElement(
      ...
      value && /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-remove-icon", onClick: removeIcon }, /* @__PURE__ */ wp.element.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 512" }, /* @__PURE__ */ wp.element.createElement("path", { d: "M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z" }))),
      /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-selected-icon" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-selected-icon-overlay" }), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-selected-icon-value" }, value ? /* @__PURE__ */ wp.element.createElement("span", { dangerouslySetInnerHTML: { __html: value.svg } }) : /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-no-icon" }, /* @__PURE__ */ wp.element.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", style: { opacity: 0.4 } }, /* @__PURE__ */ wp.element.createElement("path", { d: "M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" }))))),
      /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-actions" }, /* @__PURE__ */ wp.element.createElement("span", null, value ? __11("Change Icon", "digiblocks") : __11("Click to choose your icon", "digiblocks")))
      ...
      /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-header" }, /* @__PURE__ */ wp.element.createElement("h2", null, __11("Select Icon", "digiblocks")), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-search-container" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-search-bar" }, /* @__PURE__ */ wp.element.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, /* @__PURE__ */ wp.element.createElement("path", { d: "M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z" })), /* @__PURE__ */ wp.element.createElement(
        ...
        "span",
        {
          ...
          title: __11("Clear Search", "digiblocks")
        },
        "\xD7"
      )))),
      hasError && /* @__PURE__ */ wp.element.createElement(Notice, { status: "error", isDismissible: false }, /* @__PURE__ */ wp.element.createElement("strong", null, __11("Icon Loading Error:", "digiblocks")), /* @__PURE__ */ wp.element.createElement("br", null), errorMessage, /* @__PURE__ */ wp.element.createElement("br", null), /* @__PURE__ */ wp.element.createElement("br", null), /* @__PURE__ */ wp.element.createElement("strong", null, __11("Troubleshooting:", "digiblocks")), /* @__PURE__ */ wp.element.createElement("ul", { style: { marginLeft: "20px", marginTop: "10px" } }, /* @__PURE__ */ wp.element.createElement("li", null, __11("1. Make sure you've run the icon generation script: npm run generate:icons", "digiblocks")), /* @__PURE__ */ wp.element.createElement("li", null, __11("2. Check that includes/icons/all-icons.json exists and is not empty", "digiblocks")), /* @__PURE__ */ wp.element.createElement("li", null, __11("3. Try clearing your browser cache and refreshing the page", "digiblocks")))),
      /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-lr-container" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-left" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-categories-list" }, categories.map((category) => /* @__PURE__ */ wp.element.createElement(
        ...
        category.count,
        ")"
      )))), /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-right" }, /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-modal-container" }, isLoading ? /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-loading" }, /* @__PURE__ */ wp.element.createElement(Spinner, null), /* @__PURE__ */ wp.element.createElement("p", null, __11("Loading icons...", "digiblocks"))) : visibleIcons.length === 0 ? /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-icons icon-not-found" }, /* @__PURE__ */ wp.element.createElement("p", null, __11("No icons found. Try a different search term or category.", "digiblocks")), searchTerm && /* @__PURE__ */ wp.element.createElement(
        Button8,
        {
          isSecondary: true,
          onClick: () => setSearchTerm("")
        },
        __11("Clear Search", "digiblocks")
      )) : /* @__PURE__ */ wp.element.createElement("div", { className: "digiblocks-ip-icons" }, visibleIcons.map((icon) => /* @__PURE__ */ wp.element.createElement(
        "div",
        {
          key: icon.id,
        ...
        __11("Load More", "digiblocks"),
        " (",
        icons.length - visibleIcons.length,
        " ",
        __11("remaining", "digiblocks"),
        ")"
      ))))),
  ...
  window.wp.digiBlocks = window.wp.digiBlocks || {};
  window.wp.digiBlocks.getBlockActiveStatus = (blockName) => {
    if (typeof digiBlocksData !== "undefined" && digiBlocksData.inactiveBlocks && typeof digiBlocksData.inactiveBlocks[blockName] !== "undefined" && digiBlocksData.inactiveBlocks[blockName] === true) {
      return false;
    }
    return true;
  };
  window.wp.digiBlocks.isDigiActive = () => {
    return typeof digiBlocksData !== "undefined" && digiBlocksData.isDigiActive;
  };
  window.wp.digiBlocks.isDigiProActive = () => {
    return typeof digiBlocksData !== "undefined" && digiBlocksData.isDigiProActive;
  };
  window.wp.digiBlocks.isWooActive = () => {
  ...
  window.digi.createDeviceToggleButton = (Button9, className = "") => {
    const { __: __12 } = window.wp.i18n;
    return /* @__PURE__ */ wp.element.createElement(
      Button9,
      {
        className: `digiblocks-responsive-common-button ${className}`,
        onClick: () => window.digi.responsiveState.toggleDevice(),
        "aria-label": __12(`Switch to ${window.digi.responsiveState.getNextDevice()} view`, "digiblocks")
      },
  ...
  window.digi.utils.UnitsSelector = units_selector_default;
  ...
  window.digi.components.TabPanelBody = ({ tab, name, title, children, initialOpen = false }) => {
    ...
    const { useState: useState10, useEffect: useEffect9 } = window.wp.element;
    ...
    const [isOpen, setIsOpen] = useState10(getSavedState());
  ...
  window.digi.components.GradientControl = gradient_control_default;
  ...
  window.digi.components.TransformControl = transform_control_default;
