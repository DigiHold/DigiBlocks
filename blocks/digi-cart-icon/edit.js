...
/**
 * Edit function for the DigiCommerce Cart Icon block
 */
const DigiCartIconEdit = ({ attributes, setAttributes, clientId }) => {
    const {
        id,
        anchor,
        visibility,
    ...
    const renderPreview = () => {
        ...
        return (
			<div className="digiblocks-cart-icon-link">
				...
				{showTotal && (
					<span className="digiblocks-cart-total">{digiBlocksData.digiCurrency}49.99</span>
				)}
			</div>
        );
    };
...
export default DigiCartIconEdit;