<?php
/**
 * DigiCommerce Product Reviews Block Styles
 *
 * @package DigiBlocks
 */
...
ob_start();
?>
/* DigiCommerce Product Reviews Block - <?php echo esc_attr( $id ); ?> */
...
.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews {
    display: flex;
    align-items: center;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews-link {
    display: flex;
    align-items: center;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews-link:hover {
    text-decoration: none;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews-stars {
    display: flex;
    align-items: center;
    gap: 2px;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-star {
    width: <?php echo esc_attr( $starsSize['desktop'] ); ?>px;
    height: <?php echo esc_attr( $starsSize['desktop'] ); ?>px;
    transition: transform 0.2s ease;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-star .star-filled {
    stop-color: <?php echo esc_attr( $starsColor ); ?>;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-star .star-empty {
    stop-color: <?php echo esc_attr( $starsEmptyColor ); ?>;
}

.<?php echo esc_attr( $id ); ?> .screen-reader-text {
    position: absolute;
    left: -9999px;
    width: 1px;
    height: 1px;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews-count {
...
.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews-link:hover .digiblocks-digi-product-reviews-count {
    color: <?php echo esc_attr( $countHoverColor ); ?>;
}
<?php endif; ?>

.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews-text {
...
.<?php echo esc_attr( $id ); ?> .digiblocks-digi-product-reviews-link:hover .digiblocks-digi-product-reviews-text {
...
@media (max-width: 991px) {
    ...
    .<?php echo esc_attr( $id ); ?> .digiblocks-star {
        width: <?php echo esc_attr( $starsSize['tablet'] ); ?>px;
        height: <?php echo esc_attr( $starsSize['tablet'] ); ?>px;
    }
...
@media (max-width: 767px) {
    ...
    .<?php echo esc_attr( $id ); ?> .digiblocks-star {
        width: <?php echo esc_attr( $starsSize['mobile'] ); ?>px;
        height: <?php echo esc_attr( $starsSize['mobile'] ); ?>px;
    }
