...
$id                              = isset( $attrs['id'] ) ? $attrs['id'] : 'digi-products-' . uniqid();
$visibility                      = isset( $attrs['visibility'] ) ? $attrs['visibility'] : [
    'desktop' => false,
    'tablet'  => false,
    'mobile'  => false,
];
$productStyle                    = isset( $attrs['productStyle'] ) ? $attrs['productStyle'] : 'grid';
...
$salePriceColor                  = isset( $attrs['salePriceColor'] ) ? $attrs['salePriceColor'] : '#e53935';
...
ob_start();
?>
/* Digi Products Block - <?php echo esc_attr( $id ); ?> */
...
.<?php echo esc_attr( $id ); ?> .digiblocks-products-container {
    display: <?php echo $productStyle === 'list' ? 'flex' : 'grid'; ?>;
    <?php if ( $productStyle === 'list' ) : ?>
...
<?php if ( $productStyle === 'list' ) : ?>
/* List layout */
.<?php echo esc_attr( $id ); ?>.style-list .digiblocks-product-item {
    flex-direction: row;
    flex-wrap: wrap;
    align-items: stretch;
}

.<?php echo esc_attr( $id ); ?>.style-list .digiblocks-product-image {
    max-width: 35%;
    width: auto;
}

.<?php echo esc_attr( $id ); ?>.style-list .digiblocks-product-image img {
    height: 100%;
    object-fit: cover;
}

.<?php echo esc_attr( $id ); ?>.style-list .digiblocks-product-content {
    flex: 1;
}
<?php endif; ?>
...
.<?php echo esc_attr( $id ); ?> .digiblocks-product-price .regular-price {
    color: <?php echo esc_attr( $priceColor ); ?>;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-product-price .regular-price.del {
    text-decoration: line-through;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-product-price .sale-price {
...
.<?php echo esc_attr( $id ); ?> .digiblocks-product-rating .star-rating {
    color: #ffc107;
}
...
.<?php echo esc_attr( $id ); ?> .digiblocks-product-rating .star.half {
    position: relative;
    opacity: 0.7;
}

/* View product button */
.<?php echo esc_attr( $id ); ?> .digiblocks-product-view {
    display: flex;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-product-view:hover {
...
<?php if ( $productStyle !== 'list' && $cardStyle ) : ?>
.<?php echo esc_attr( $id ); ?> .digiblocks-product-item:hover {
...
/* Animation */
<?php if ( $animation && $animation !== 'none' && function_exists( 'digiblocks_get_animation_css' ) ) : ?>
<?php echo esc_attr( digiblocks_get_animation_css( $animation, $id ) ); ?>
<?php endif; ?>
