...
$id                              = isset( $attrs['id'] ) ? $attrs['id'] : 'digi-search-results-' . uniqid();
...
$headingColor                    = isset( $attrs['headingColor'] ) ? $attrs['headingColor'] : '#333333';
$noResultsColor                  = isset( $attrs['noResultsColor'] ) ? $attrs['noResultsColor'] : '#666666';
...
ob_start();
?>
/* Search Results Block - <?php echo esc_attr( $id ); ?> */
...
/* Block Heading */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-results-heading {
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-no-results {
    color: <?php echo esc_attr( $noResultsColor ); ?>;
    text-align: center;
    padding: 2rem;
...
/* Grid layout */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-container {
...
<?php if ( $postStyle === 'list' ) : ?>
    /* List layout */
    .<?php echo esc_attr( $id ); ?>.style-list .digiblocks-search-item {
        flex-direction: row;
        flex-wrap: wrap;
        align-items: stretch;
    }

    .<?php echo esc_attr( $id ); ?>.style-list .digiblocks-search-image {
        max-width: 35%;
        width: auto;
    }

    .<?php echo esc_attr( $id ); ?>.style-list .digiblocks-search-image img {
        height: 100%;
        object-fit: cover;
    }

    .<?php echo esc_attr( $id ); ?>.style-list .digiblocks-search-content {
        flex: 1;
    }
<?php endif; ?>

/* Search item */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-item {
    display: flex;
    flex-direction: column;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-item:hover {
...
/* Featured image */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-image {
    width: 100%;
    overflow: hidden;
    <?php echo esc_attr( digiblocks_get_dimensions( $imageBorderRadius, 'border-radius', 'desktop' ) ); ?>
}

.<?php echo esc_attr( $id ); ?> .digiblocks-search-image img {
    width: 100%;
    height: auto;
    display: block;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-image:hover img {
    transform: scale(1.05);
}

/* Content */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-content {
    display: flex;
    flex-direction: column;
...
/* Search result title */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-title {
    margin: 0;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-title a {
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-title a:hover {
    color: <?php echo esc_attr( $titleHoverColor ); ?>;
}
<?php endif; ?>

/* Search result excerpt */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-excerpt {
    <?php if ( ! empty( $contentTypography['fontFamily'] ) ) : ?>
    font-family: <?php echo esc_attr( $contentTypography['fontFamily'] ); ?>;
    <?php endif; ?>
    <?php if ( ! empty( $contentTypography['fontSize']['desktop'] ) ) : ?>
...
/* Meta information */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-meta {
    display: flex;
    flex-wrap: wrap;
    gap: 10px;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-meta a {
    color: <?php echo esc_attr( $metaColor ); ?>;
    text-decoration: none;
    transition: color 0.3s ease;
}
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-meta a:hover {
    color: <?php echo esc_attr( $metaHoverColor ); ?>;
}
<?php endif; ?>

/* Read more button */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-read-more {
    display: inline-flex;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-read-more:hover {
    background-color: <?php echo esc_attr( $buttonBackgroundHoverColor ); ?>;
    color: <?php echo esc_attr( $buttonTextHoverColor ); ?>;
}

/* Pagination */
.<?php echo esc_attr( $id ); ?> .digiblocks-search-pagination {
    margin-top: 2rem;
    text-align: center;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-search-pagination .nav-links {
    display: inline-flex;
    gap: 0.5rem;
    align-items: center;
    flex-wrap: wrap;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-pagination .page-numbers {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    min-width: 40px;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-search-pagination .page-numbers:hover,
.<?php echo esc_attr( $id ); ?> .digiblocks-search-pagination .page-numbers.current {
    background-color: <?php echo esc_attr( $buttonBackgroundHoverColor ); ?>;
    color: <?php echo esc_attr( $buttonTextHoverColor ); ?>;
}
