    ...
    attributes: {
        ...
        contentTypography: {
            ...
            default: {
                ...
                textTransform: '',
                textDecoration: '',
                lineHeight: { desktop: { value: 1.7, unit: 'em' }, tablet: { value: '', unit: 'em' }, mobile: { value: '', unit: 'em' } },
        ...
        headingTypography: {
            ...
            default: {
                ...
                textTransform: '',
                textDecoration: '',
                lineHeight: { desktop: { value: 1.3, unit: 'em' }, tablet: { value: '', unit: 'em' }, mobile: { value: '', unit: 'em' } },
                letterSpacing: { desktop: { value: '', unit: 'px' }, tablet: { value: '', unit: 'px' }, mobile: { value: '', unit: 'px' } }
            }
        },
        textTypography: {
            ...
            default: {
                fontFamily: '',
                fontSize: { desktop: { value: 14, unit: 'px' }, tablet: { value: '', unit: 'px' }, mobile: { value: '', unit: 'px' } },
                fontWeight: '',
                fontStyle: 'normal',
                textTransform: '',
                textDecoration: '',
                lineHeight: { desktop: { value: 1.4, unit: 'em' }, tablet: { value: '', unit: 'em' }, mobile: { value: '', unit: 'em' } },
                letterSpacing: { desktop: { value: 0.5, unit: 'px' }, tablet: { value: '', unit: 'px' }, mobile: { value: '', unit: 'px' } }
            }
        },
        imageSize: {
            type: 'object',
