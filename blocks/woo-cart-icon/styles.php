...
$countBackgroundColor             = isset( $attrs['countBackgroundColor'] ) ? $attrs['countBackgroundColor'] : '#e74c3c';
$countHoverColor                  = isset( $attrs['countHoverColor'] ) ? $attrs['countHoverColor'] : '#ffffff';
$countHoverBackgroundColor        = isset( $attrs['countHoverBackgroundColor'] ) ? $attrs['countHoverBackgroundColor'] : '#c0392b';
...
$miniCartRemoveColor              = isset( $attrs['miniCartRemoveColor'] ) ? $attrs['miniCartRemoveColor'] : '#e74c3c';
$miniCartRemoveHoverColor         = isset( $attrs['miniCartRemoveHoverColor'] ) ? $attrs['miniCartRemoveHoverColor'] : '#c0392b';
...
.<?php echo esc_attr( $id ); ?> .digiblocks-mini-cart-item-image {
	width: 50px;
	height: 50px;
	flex-shrink: 0;
}

.<?php echo esc_attr( $id ); ?> .digiblocks-mini-cart-item-image img {
	width: 100%;
	height: 100%;
	object-fit: cover;
	border-radius: 4px;
...
.<?php echo esc_attr( $id ); ?> .digiblocks-mini-cart-item-quantity {
	background: none;
	border: 1px solid <?php echo esc_attr( $miniCartBorderColor ); ?>;
	width: 50px;
	text-align: center;
