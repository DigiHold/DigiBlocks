...
/**
 * Edit function for the Product Gallery block
 */
const WooProductGalleryEdit = ({ attributes, setAttributes, clientId }) => {
    const {
        id,
        anchor,
        visibility,
    ...
    const imageSizeOptions = [
        ...
        { label: __('WooCommerce Single', 'digiblocks'), value: 'woocommerce_single' },
        { label: __('WooCommerce Thumbnail', 'digiblocks'), value: 'woocommerce_thumbnail' },
        { label: __('WooCommerce Gallery Thumbnail', 'digiblocks'), value: 'woocommerce_gallery_thumbnail' }
    ];
                ...
                return (
                    <>
                        ...
                        >
							...
							>
								{__('This is a placeholder. The actual product images will be displayed on single product pages.', 'digiblocks')}
							</Notice>
    ...
    // Build class names
    const blockClasses = `digiblocks-product-gallery-block ${id} ${customClasses || ""}`;
                ...
                <div className={`digiblocks-product-gallery thumbnail-${thumbnailPosition}`}>
                    ...
                    <div className="digiblocks-main-image">
                        <img 
                            ...
                            alt={__('Product Image', 'digiblocks')}
                        />
                        {enableLightbox && (
                    ...
                    <div className="digiblocks-thumbnails">
                        {mockImages.map((image, index) => (
                            ...
                            >
                                <img 
                                    src={image} 
                                    alt={__('Product Thumbnail', 'digiblocks') + ' ' + (index + 1)}
                                />
                            </div>
                        ))}
                    </div>
...
export default WooProductGalleryEdit;