...
/**
 * Edit function for the Product Meta block
 */
const WooProductMetaEdit = ({ attributes, setAttributes, clientId }) => {
    const {
        id,
        anchor,
        visibility,
    ...
    const generateCSS = () => {
        ...
        return `
            ...
            .${id} .digiblocks-sku-value {
                color: ${skuColor};
                font-family: 'Courier New', monospace;
                background: ${skuBackgroundColor};
                padding: 2px 6px;
                ...
                return (
                    <>
                        ...
                        >
                            ...
                            {showSKU && (
                                <TextControl
                                    label={__('SKU Label', 'digiblocks')}
                                    value={skuLabel}
                                    onChange={(value) => setAttributes({ skuLabel: value })}
                                        ...
                                        return (
                                            <PanelColorSettings
                                                ...
                                                colorSettings={[
                                                    ...
                                                    {
                                                        value: skuColor,
                                                        onChange: (value) => setAttributes({ skuColor: value }),
                                                        label: __("SKU Color", "digiblocks"),
                                                    },
                                                    {
                                                        value: skuBackgroundColor,
                                                        onChange: (value) => setAttributes({ skuBackgroundColor: value }),
                                                        label: __("SKU Background", "digiblocks"),
                                                    },
                                                    {
                                                        value: categoryColor,
        ...
        <>
            ...
            <div {...blockProps}>
                <div className="digiblocks-product-meta-container">
                    {showSKU && (
                        <div className="digiblocks-meta-item digiblocks-sku-item">
                            <span className="digiblocks-meta-label">{skuLabel}</span>
                            <div className="digiblocks-meta-value">
                                <span className="digiblocks-sku-value">WC-123-ABC</span>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="digiblocks-meta-item digiblocks-categories-item">
                            ...
                            <div className="digiblocks-meta-value">
                                <a href="#" className="digiblocks-category-link" onClick={(e) => e.preventDefault()}>
                                    {__('Electronics', 'digiblocks')}
                                </a>
                                <a href="#" className="digiblocks-category-link" onClick={(e) => e.preventDefault()}>
                                    {__('Gadgets', 'digiblocks')}
                                </a>
                            </div>
                        </div>
                    )}
                        ...
                        <div className="digiblocks-meta-item digiblocks-tags-item">
                            ...
                            <div className="digiblocks-meta-value">
                                <a href="#" className="digiblocks-tag-link" onClick={(e) => e.preventDefault()}>
                                    {__('wireless', 'digiblocks')}
                                </a>
                                <a href="#" className="digiblocks-tag-link" onClick={(e) => e.preventDefault()}>
                                    {__('portable', 'digiblocks')}
                                </a>
                                <a href="#" className="digiblocks-tag-link" onClick={(e) => e.preventDefault()}>
                                    {__('modern', 'digiblocks')}
                                </a>
                            </div>
                        </div>
                    )}
...
export default WooProductMetaEdit;