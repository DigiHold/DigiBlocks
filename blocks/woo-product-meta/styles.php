...
$skuColor                          = isset( $attrs['skuColor'] ) ? $attrs['skuColor'] : '#333333';
...
$skuBackgroundColor                = isset( $attrs['skuBackgroundColor'] ) ? $attrs['skuBackgroundColor'] : 'rgba(0, 0, 0, 0.05)';
...
ob_start();
?>
/* Product Meta Block - <?php echo esc_attr( $id ); ?> */
...
.<?php echo esc_attr( $id ); ?> .digiblocks-sku-value {
    color: <?php echo esc_attr( $skuColor ); ?>;
    font-family: 'Courier New', monospace;
    background: <?php echo esc_attr( $skuBackgroundColor ); ?>;
    padding: 2px 6px;
